...
- Warning counter: `essid_control_bytes_warned` (SSIDs that survived the spec gate but contained at least one byte in `0x00..=0x1F`; not a rejection).
